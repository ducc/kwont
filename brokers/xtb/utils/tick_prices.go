...
func TickPriceToCandlestick(tickPrice *streaming.GetTickPricesResponse) (*protos.Candlestick, error) {
	...
	return &protos.Candlestick{
		...
		Current:    PoundsToMicros(int64(tickPrice.Data.Ask)),
		Low:        PoundsToMicros(int64(tickPrice.Data.Low)),
		High:       PoundsToMicros(int64(tickPrice.Data.High)),
		Spread:     PoundsToMicros(int64(tickPrice.Data.SpreadRaw)),
